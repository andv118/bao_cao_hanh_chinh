    ...
    function checkValidate() {
        ...
        var status = false; //Biến trạng thái
            ...
            if ( keyword == "") {
                ...
                document.getElementById("lbsearch").innerHTML = "Hãy nhập số cmnd để tìm kiếm";
                status = true;
            }else{
...
<div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-home"></i>/Tìm kiếm danh bạ</b></div>
            <div class="panel-body">
                <div class="bootstrap-table">
                    <div class="fixed-table-toolbar"></div>
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;margin:20px 0;"><b><i class="fa fa-search"></i> TÌM KIẾM DANH BẠ </b></h3>
                        </div>
                         
                        <form action="{{route('admin.export_search_phonebook')}}" method="post">
                            @csrf
                        ...
                        <div class="fixed-table-body table-responsive">
                            ...
                            <h4><b><i class="fa fa-search-plus"></i> Kết quả tìm kiếm : </b><b style="color: red;">{{count($data)}}</b></h4>
                            @if(count($data)>0)
                            <table data-toggle="table" class="table table-hover table-bordered table-striped jambo_table bulk_action">
                                ...
                                <tbody id="content" style="display: block;overflow: auto;max-height: 500px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"><a class="btn btn-danger" href="{{route('admin.delete_phonebook',$v->id_phonebook)}}"><i class="far fa-trash-alt" style="color: white;"></i></a></td>
                            ...
                            <div class="alert alert-danger" style="margin-top: 20px;">
                                ...
                                <strong>Không tìm thấy danh bạ !</strong>
                            </div>
                            @endif
