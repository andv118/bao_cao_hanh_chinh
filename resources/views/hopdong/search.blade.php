...
<script>
  ...
  <div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-home"></i>/Tìm kiếm hợp đồng</b></div>
            <div class="panel-body">
                <div class="bootstrap-table">
                    <div class="fixed-table-toolbar"></div>
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;"><b><i class="fa fa-search"></i> TÌM KIẾM HỢP ĐỒNG</b></h3>
                        </div>
                         <form action="{{route('admin.export_search_contract')}}" method="post">
                            @csrf
                        ...
                        <div class="fixed-table-body table-responsive">
                            <div class="fixed-table-loading " style="top: 37px; display: none;">Loading, please wait…</div>
                              ...
                              @endif
                             <h4 style="margin: 20px 0;"><b><i class="fa fa-search-plus"></i> Kết quả tìm kiếm : <span style="color: red;">{{count($data)}}</span></b></h4>
                                ...
                                <tbody style="height: 500px;overflow: auto;width: 100%;display: block;">
                                    ...
                                    @foreach($data as $v)
                                      <tr>
                                         ...
                                         <td style="text-align:center;font-size:14px;;"><a href="{{route('admin.update_contract',$v->id)}}" style="color: orange;" title="Cập Nhật Hợp Đồng"><i class="fa fa-edit"></i></a></td>
                                     </tr> 
                                    @endforeach
                                </tbody>
                            </table>
