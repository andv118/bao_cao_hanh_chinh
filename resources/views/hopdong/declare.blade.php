                            ...
                            <div class="fixed-table-loading " style="top: 37px; display: none;">Loading, please wait…</div>
                             <form class="col-sm-8 form-horizontal col-sm-offset-2" enctype="multipart/form-data" method="post" action="{{route('admin.save_contract')}}" onsubmit="return checkValidate();">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="taxcode" value="{{$data2[0]['tax_code']}}" name="taxcode" placeholder="Mã số thuế">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="fullname" name="fullname" value="{{$data2[0]['fullname']}}" id="name" placeholder="Tên chủ nhà">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="propertycode" name="propertycode" value="{{$data2[0]['code']}}" placeholder="Mã tài sản">
                                    ...
                                    <div class="form-group">
                                        <label for="MST" class="col-sm-2 control-label">1.7. Thời hạn hợp đồng</label><br>
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                <label for="MST"  class="col-sm-2 control-label">1.7.1 Từ ngày</label>
                                                <div class="col-sm-8">
                                                    <input type="text" id="from" name="from" placeholder="Chọn ngày"  class="form-control">
                                                    <span style="color: red;" id="lbfrom"></span>

                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="MST" class="col-sm-2 control-label">1.7.2 Đến ngày</label>
                                                <div class="col-sm-8">
                                                    <input type="text" id="to" name="to" placeholder="Chọn ngày" class="form-control">
                                     ...
                                     <div class="form-group">
                                        <label for="name" class="col-sm-2 control-label">1.8. Kỳ thanh toán</label>
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                <label for="MST" class="col-sm-2 control-label">1.8.1 Theo tháng</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label for="MST" class="col-sm-2 control-label">1.8.2 Theo năm</label>
                                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-2 control-label">1.9. Giá toàn bộ hợp đồng/tháng </label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-2 control-label">1.10. Đơn vị tiền tệ</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                      <div class="col-sm-offset-2 col-sm-10">
                                        <button type="submit" class="btn btn-success" style="margin-left: 30%;"><i class="fa fa-wrench"></i> Thêm mới hợp đồng</button>
                                    </div>
                                </div>
                            </form>
                        </div>                 
