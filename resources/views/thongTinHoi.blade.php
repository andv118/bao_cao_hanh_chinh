                ...
                <div class="bootstrap-table">
                    ...
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;padding: 10px 10px;text-transform: uppercase; "><b>THÔNG TIN VỀ HỘI
                        ...
                        <div class="fixed-table-body tab-content">
                            <div id="form_info_1" class="tab-pane fade in active">
                                <form class="col-xs-12 form-horizontal form_input_default" enctype="multipart/form-data" method="post" action="{{route('admin.saveInfo')}}">
                                    @csrf
                                    <h3>I. TÊN HỘI:</h3>
                                    ...
                                    <h3>II. LOẠI HỘI :</h3>
                                    	<strong>
                                        	@foreach( $detail_info as $item )
	                                        @if($item->ToChucChinhTriXaHoi == 1)
	                                        Tổ chức chính trị xã hội
	                                        @elseif($item->ToChucChinhTriXaHoiNgheNghiep == 1)
											Tổ chức chính trị xã hội nghề nghiệp
											@elseif($item->ToChucXaHoiNgheNghiep == 1)
											Tổ chức xã hội nghề nghiệp
											@elseif($item->ToChucKinhTe == 1)
											Tổ chức kinh tế
											@elseif($item->ToChucXaHoiNhanDaoTuNhien == 1)
											Tổ chức xã hội nhân đạo tự nhiên
											@else
											Không có
	                                        @endif
											@endforeach
                                    ...
                                    <div class="block_input">
                                        ...
                                        <strong>
                                        	@foreach( $detail_info as $item )
	                                        @if($item->PhamViThanhPho == 1)
	                                        Cấp Thành Phố
	                                        @elseif($item->PhamViQuanHuyen == 1)
											Cấp Quận huyện
											@elseif($item->PhamViXaPhuong == 1)
											Cấp Xã phường
	                                        @endif
											@endforeach
                                        </strong>
                                    ...
                                    <div class="block_input">
                                        ...
                                        <strong>
                                        	@foreach( $detail_info as $item )
	                                        @if($item->NhiemKy2nam == 1)
	                                        2 Năm
	                                        @elseif($item->NhiemKy3nam == 1)
											3 Năm
											@elseif($item->NhiemKy5nam == 1)
											5 Năm
	                                        @endif
											@endforeach
                                        </strong>
