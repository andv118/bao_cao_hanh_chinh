                ...
                <div class="bootstrap-table">
                    ...
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;"><b>Có Thông Tin Giá Tham Khảo Cho Thuê Trên 100 Triệu Nhưng Chưa Quản Lý</b></h3>
                        </div>
                        <a href="{{route('admin.export_error4')}}" class="btn btn-warning"><i class="fa fa-download"></i> Xuất file Excel</a>
                            ...
                            <table data-toggle="table"  class="table table-hover table-bordered table-responsive table-striped jambo_table bulk_action">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="1" style="text-align: center;">Mã Tài Sản</th>
                                        <th  colspan="1" style="text-align: center;">Tên Chủ Nhà</th>
                                        <th  colspan="1" style="text-align: center;">Đoạn Đường </th>
                                        <th colspan="1" style="text-align: center;">Tuyến Phố </th>
                                        <th  colspan="1" style="text-align: center;">Vị Trí</th>
