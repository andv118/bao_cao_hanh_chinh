...
@section('content')
  <div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-home"></i>| Quản lý phiếu đánh giá hội | Chi tiết</b></div>
                        ...
                        <div class="fixed-table-body" style="margin-top: 30px;">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group">
                                   ...
                                   <b> a)</b><input type="text" value="Hội có hoạt động hiệu quả không" class="form-control" style="width: 400px;"> 
                                ...
                                <table data-toggle="table"  class="table table-hover table-bordered table-responsive table-striped jambo_table bulk_action">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="text-align: center;"><input type="text" value="a" name="" class="form-control"></td>
                                            <td style="text-align: center;"><input type="text" name="" value="Đạt" class="form-control"></td>
                                        ...
                                        <tr>
                                            <td style="text-align: center;"><input type="text" value="b" name="" class="form-control"></td>
                                            <td style="text-align: center;"><input type="text" value="Không đạt" name="" class="form-control"></td>
                                            <td style="text-align: center;"><input type="text" name="" class="form-control"></td>
                                            <td style="text-align: center;"><input type="text" name="" class="form-control"></td>
                                            <td style="text-align: center;"><input type="text" name="" class="form-control"></td>
                                            <td style="text-align: center;"><input type="text" name="" class="form-control"></td>
                                        ...
                                        <tr>
                                            <td style="text-align: center;"><input type="text" value="c" name="" class="form-control"></td>
                                            <td style="text-align: center;"><input type="text" value="Đạt" name="" class="form-control"></td>
                                            <td style="text-align: center;"><input type="text" name="" class="form-control"></td>
                                            <td style="text-align: center;"><input type="text" name="" class="form-control"></td>
                                            <td style="text-align: center;"><input type="text" name="" class="form-control"></td>
                                            <td style="text-align: center;"><input type="text" name="" class="form-control"></td>
                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align: center;">Đạt</td>
