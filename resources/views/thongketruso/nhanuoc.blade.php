...
<div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-home"></i>|Thống kê theo trụ sở hoạt động|Thống kê theo trụ sở do nhà nước cấp</b></div>
            <div class="panel-body">
                <div class="bootstrap-table">
                    <div class="fixed-table-toolbar"></div>
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;padding: 20px 20px;"><b><i class="fa fa-list-alt"></i> DANH SÁCH TRỤ SỞ CÓ HỘI DO NHÀ NƯỚC CẤP HOẶC CẤP TIỀN THUÊ TRỤ SỞ</b></h3>
                        </div>
                            ...
                            <table data-toggle="table"  class="table table-hover table-bordered table-responsive table-striped jambo_table bulk_action" id="content">
                               <thead>
                                    <tr>
                                        ...
                                        <th colspan="1" style="text-align: center;">Nhà nước cấp</th>
                                ...
                                <tbody>
                                   <tr>
                                       ...
                                       <td style="text-align: center;font-size: 16px;">Do huyện bố trí</td>
