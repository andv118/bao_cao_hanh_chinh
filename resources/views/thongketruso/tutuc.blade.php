...
<div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-home"></i>|Thống kê theo trụ sở hoạt động|Thống kê theo trụ sở do hội tự túc</b></div>
            <div class="panel-body">
                <div class="bootstrap-table">
                    <div class="fixed-table-toolbar"></div>
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;padding: 20px 20px;text-transform: uppercase;"><b><i class="fa fa-list-alt"></i> Danh sách các hội có trụ sở tự túc</b></h3>
                        </div>
                            ...
                            <table data-toggle="table"  class="table table-hover table-bordered table-responsive table-striped jambo_table bulk_action" id="content">
                               <thead>
                                    <tr>
                                        ...
                                        <th colspan="1" style="text-align: center;">Trụ sở tự trang bị</th>
                                        <th colspan="1" style="text-align: center;">TP</th>
                                        <th colspan="1" style="text-align: center;">HD</th>
                                </thead>
                                <tbody>
                                   <tr>
                                       <td style="text-align: center;font-size: 16px;">1</td>
                                       <td style="text-align: center;font-size: 16px;">Hội gốm sứ bát tràng thành phố Hà Nội</td>
                                       <td style="text-align: center;font-size: 16px;">Thôn 3 Bát Tràng, xã Bát Tràng, Gia Lâm, Hà Nội</td>
                                       <td style="text-align: center;font-size: 16px;">Lê Xuân Phố</td>
                                       <td style="text-align: center;font-size: 16px;color: red;">Sở công thương</td>
                                       <td style="text-align: center;font-size: 16px;">Hội viên cho nhờ</td>
                                   ...
                                   <tr>
                                       ...
                                       <td style="text-align: center;font-size: 16px;color: red;">Sở công thương</td>
                                       <td style="text-align: center;font-size: 16px;">Tự trang trải</td>
                                        <td style="text-align: center;font-size: 16px;"><input type="checkbox" checked="true"></td>
                                       <td style="text-align: center;font-size: 16px;"></td>
                                   </tr>
