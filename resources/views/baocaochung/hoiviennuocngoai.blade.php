...
<div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-home"></i>|Báo cáo chung|Thống kế hội viên nước ngoài</b></div>
            <div class="panel-body">
                <div class="bootstrap-table">
                    <div class="fixed-table-toolbar"></div>
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;padding: 20px 20px;"><b><i class="fa fa-list-alt"></i> THỐNG KÊ HỘI VIÊN NƯỚC NGOÀI</b></h3>
                        </div>
                               ...
                               <thead>
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                       ...
                                       <td style="text-align: center;font-size: 16px;">30-06-1985</td>
                                       <td style="text-align: center;">Nam</td>
                                       <td style="text-align: center;">Thành viên</td>
                                       <td style="text-align: center;"></td>
                                   </tr>
