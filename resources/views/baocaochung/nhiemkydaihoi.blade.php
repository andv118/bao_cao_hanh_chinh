...
<div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-home"></i>|Báo cáo chung|Báo cáo nhiệm kỳ đại hội</b></div>
            <div class="panel-body">
                <div class="bootstrap-table">
                    <div class="fixed-table-toolbar"></div>
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;padding: 20px 20px;"><b><i class="fa fa-list-alt"></i> BÁO CÁO NHIỆM KỲ ĐẠI HỘI</b></h3>
                        </div>
                            ...
                            <table data-toggle="table"  class="table table-hover table-bordered table-responsive table-striped jambo_table bulk_action" id="content">
                               <thead>
                                    <tr>
                                        ...
                                        <th colspan="1" style="text-align: center;">Nhiệm kỳ của hội (năm )</th>
                                        <th colspan="1" style="text-align: center;">Từ khi thành lập đến nay đã qua bao nhiêu kỳ đại hội</th>
                                </thead>
                                <tbody>
                                   <tr>
