...
<div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-home"></i>|Báo cáo chung|Thống kê theo phạm vi hoạt động</b></div>
            <div class="panel-body">
                <div class="bootstrap-table">
                    <div class="fixed-table-toolbar"></div>
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;padding: 20px 20px;"><b><i class="fa fa-list-alt"></i> DANH SÁCH HỘI THEO PHẠM VI HOẠT ĐỘNG</b></h3>
                        </div>
                            ...
                            <table data-toggle="table"  class="table table-hover table-bordered table-responsive table-striped jambo_table bulk_action" id="content">
                               <thead>
                                    <tr>
                                        ...
                                        <th colspan="1" style="text-align: center;">Phạm vi hoạt động</th>
                                </thead>
                                <tbody>
                                   <tr>
                                       ...
                                       <td style="text-align: center;color: red;font-weight: bold;">Thành Phố</td>
                                   </tr>
                                   <tr>
                                       ...
                                       <td style="text-align: center;">Sở nội vụ</td>
                                       <td style="text-align: center;color: red;font-weight: bold;">Quận, huyện</td>
                                   </tr>
                                   <tr>
                                       ...
                                       <td style="text-align: center;">Sở nội vụ</td>
                                       <td style="text-align: center;color: red;font-weight: bold;">Xã phường, thị trấn</td>
                                   </tr>
                                </tbody>
                            </table>
