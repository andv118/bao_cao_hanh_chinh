...
<div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-home"></i>|Báo cáo chung|Thống kê chi phí</b></div>
            <div class="panel-body">
                <div class="bootstrap-table">
                    <div class="fixed-table-toolbar"></div>
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;padding: 20px 20px;"><b><i class="fa fa-list-alt"></i> DANH SÁCH HỘI THEO CHI PHÍ</b></h3>
                        </div>
                            ...
                            <table data-toggle="table"  class="table table-hover table-bordered table-responsive table-striped jambo_table bulk_action" id="content">
                               <thead>
                                    <tr>
                                        ...
                                        <th colspan="3" style="text-align: center;">Chi phí (vnđ)</th>
                                    </tr>
                                    <tr>
                                        <th  style="text-align: center;">Năm 2014</th>
                                        <th  style="text-align: center;">Năm 2015</th>
                                        <th  style="text-align: center;">Năm 2016</th>
                                    </tr>
                                </thead>
                                <tbody>
                                   <tr>
                                       ...
                                       <td style="text-align: center;color: red;font-weight: bold;">12,000,000</td>
                                       <td style="text-align: center;color: red;font-weight: bold;">11,500,000</td>
                                       <td style="text-align: center;color: red;font-weight: bold;">100,000,000</td>
                                   </tr>
                                   <tr>
                                       ...
                                       <td style="text-align: center;font-weight: bold;">Sở nội vụ</td>
                                       <td style="text-align: center;color: red;font-weight: bold;">120,000,000</td>
                                       <td style="text-align: center;color: red;font-weight: bold;">80,000,000</td>
                                       <td style="text-align: center;color: red;font-weight: bold;">90,000,000</td>
                                   </tr>
                                   <tr>
                                       ...
                                       <td style="text-align: center;font-weight: bold;">Sở nội vụ</td>
                                       <td style="text-align: center;color: red;font-weight: bold;">96,000,000</td>
                                       <td style="text-align: center;color: red;font-weight: bold;">102,000,000</td>
                                       <td style="text-align: center;color: red;font-weight: bold;">150,000,000</td>
                                   </tr>
                                </tbody>
                            </table>
