...
<div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-home"></i>|Báo cáo chung|Thống kê theo loại hội</b></div>
            <div class="panel-body">
                <div class="bootstrap-table">
                    <div class="fixed-table-toolbar"></div>
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;padding: 20px 20px;"><b><i class="fa fa-list-alt"></i> DANH SÁCH HỘI THEO LOẠI HỘI</b></h3>
                        </div>
                            ...
                            <table data-toggle="table"  class="table table-hover table-bordered table-responsive table-striped jambo_table bulk_action" id="content">
                               <thead>
                                    <tr>
                                        ...
                                        <th colspan="1" style="text-align: center;">Loại hội</th>
                                </thead>
                                <tbody>
                                   <tr>
                                       ...
                                       <td style="text-align: center;color: red;font-weight: bold;">Tổ chức kinh tế</td>
                                   </tr>
                                   <tr>
                                       ...
                                       <td style="text-align: center;font-weight: bold;">Sở nội vụ</td>
                                       <td style="text-align: center;color: red;font-weight: bold;">Tổ chức chính trị-xã hội</td>
                                   </tr>
                                   <tr>
