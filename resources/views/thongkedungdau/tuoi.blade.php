...
<div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-home"></i>|Thống kê theo người đứng đầu|Thống kê theo tuổi lãnh đạo</b></div>
            <div class="panel-body">
                <div class="bootstrap-table">
                    <div class="fixed-table-toolbar"></div>
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;padding: 20px 20px;"><b><i class="fa fa-list-alt"></i> DANH SÁCH HỘI CÓ NGƯỜI ĐỨNG ĐẦU THEO TUỔI LÃNH ĐẠO</b></h3>
                        </div>
                            ...
                            <table data-toggle="table"  class="table table-hover table-bordered table-responsive table-striped jambo_table bulk_action" id="content">
                               <thead>
                                    <tr>
                                        ...
                                        <th colspan="1" style="text-align: center;">Tuổi</th>
                                ...
                                <tbody>
                                   <tr>
                                       ...
                                       <td style="text-align: center;font-size: 16px;color: green;">10 năm</td>
                                   ...
                                   <tr>
                                       ...
                                       <td style="text-align: center;font-size: 16px;color: red;">Sở nội vụ</td>
                                       <td style="text-align: center;font-size: 16px;color:green;">12 năm</td>
                                      <td style="text-align: center;font-size: 16px;"><input type="checkbox" checked="true"></td>
                                       <td style="text-align: center;font-size: 16px;"></td>
                                    ...
                                    <tr>
                                       ...
                                       <td style="text-align: center;font-size: 16px;color: red;">Sở nội vụ</td>
                                       <td style="text-align: center;font-size: 16px;color: green;">15 năm</td>
                                       <td style="text-align: center;font-size: 16px;"><input type="checkbox" checked="true"></td>
                                       <td style="text-align: center;font-size: 16px;"></td>
