...
<script>
 ...
 <div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-home"></i>/ Quản lý thuế</b></div>
            <div class="panel-body">
                <div class="bootstrap-table">
                    <div class="fixed-table-toolbar"></div>
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                            <h3 style="text-align: center;margin: 30px 0;"><b><i class="fa fa-list-alt"></i> DỮ LIỆU QUẢN LÝ THUẾ (<span style="color: red;">{{$dem}}</span>)</b></h3>
                        </div>
                        <a href="{{route('admin.export_tax')}}" class="btn btn-warning"><i class="fa fa-download"></i> Xuất file Excel</a>
