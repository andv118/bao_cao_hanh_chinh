                ...
                <div class="bootstrap-table">
                    ...
                    <div class="fixed-table-container">
                        <div class="fixed-table-header">
                        	<h3 style="text-align: center;"><b>Hợp Đồng Kê Khai Thuế Đúng Hạn</b></h3>
                        </div>
                        <div class="fixed-table-body" style="margin-top: 30px;">
                            <a style="margin-bottom: 20px;" href="{{route('admin.export_submit_ontime')}}" class="btn btn-warning"><i class="fa fa-download"></i> Xuất file Excel</a>
